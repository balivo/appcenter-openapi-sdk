...
namespace Balivo.AppCenterClient.Models
{
    ...
    public partial class AudienceDevicePropertyValuesListResult
    {
        ...
        /// AudienceDevicePropertyValuesListResult class.
        /// </summary>
        ...
        /// AudienceDevicePropertyValuesListResult class.
        /// </summary>
        /// <param name="values">List of device property values.</param>
        public AudienceDevicePropertyValuesListResult(IList<string> values)
        {
            Values = values;
            CustomInit();
        }
