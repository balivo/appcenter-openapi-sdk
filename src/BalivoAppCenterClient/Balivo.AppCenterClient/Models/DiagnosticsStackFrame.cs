...
namespace Balivo.AppCenterClient.Models
{
    ...
    /// </summary>
    public partial class DiagnosticsStackFrame
    {
        /// <summary>
        ...
        public DiagnosticsStackFrame(bool appCode, string codeRaw, string codeFormatted, string address = default(string), string className = default(string), string method = default(string), bool? classMethod = default(bool?), string file = default(string), int? line = default(int?), string frameworkName = default(string), string language = default(string), bool? relevant = default(bool?), string methodParams = default(string))
        {
            Address = address;
            ClassName = className;
            Method = method;
