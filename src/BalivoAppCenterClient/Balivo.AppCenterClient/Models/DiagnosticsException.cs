...
namespace Balivo.AppCenterClient.Models
{
    ...
    /// a exception
    /// </summary>
    public partial class DiagnosticsException
    {
        /// <summary>
        ...
        public DiagnosticsException(IList<DiagnosticsStackFrame> frames, string reason = default(string), string type = default(string), bool? relevant = default(bool?), IList<DiagnosticsException> innerExceptions = default(IList<DiagnosticsException>), string platform = default(string))
        {
            Reason = reason;
            Type = type;
            Frames = frames;
        ...
        public IList<DiagnosticsException> InnerExceptions { get; set; }
