...
namespace Balivo.AppCenterClient.Models
{
    ...
    /// </summary>
    public partial class V2MissingSymbolCrashGroup
    {
        /// <summary>
        ...
        /// group</param>
        public V2MissingSymbolCrashGroup(string symbolGroupId, string appId, string appVer, string appBuild, System.DateTime lastModified, IList<V2MissingSymbol> missingSymbols, string status, int? crashCount = default(int?))
        {
