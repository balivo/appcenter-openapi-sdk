...
namespace Balivo.AppCenterClient.Models
{
    ...
    /// parked crash
    /// </summary>
    public partial class V2ParkedCrash
    {
        /// <summary>
        /// Initializes a new instance of the V2ParkedCrash class.
        /// </summary>
        public V2ParkedCrash()
        {
            CustomInit();
        }
        ...
        /// crash</param>
        public V2ParkedCrash(string appId, string appVer, string appBuild, IList<V2MissingSymbol> missingSymbols, string crashId, string sdkPlatform, V2CrashLocation location, string sdkWrapper = default(string))
        {
            AppId = appId;
            AppVer = appVer;
            AppBuild = appBuild;
        ...
        public IList<V2MissingSymbol> MissingSymbols { get; set; }
        ...
        public V2CrashLocation Location { get; set; }
