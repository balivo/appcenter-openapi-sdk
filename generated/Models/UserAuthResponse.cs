...
namespace Balivo.AppCenterClient.Models
{
    ...
    public partial class UserAuthResponse
    {
        ...
        /// provider</param>
        public UserAuthResponse(System.Guid id, string displayName, string email, string name, string origin, string externalProvider = default(string), string externalUserId = default(string))
        {
            Id = id;
