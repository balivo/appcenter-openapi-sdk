...
namespace Balivo.AppCenterClient.Models
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the DistributionStoreWithoutIsLatest
        /// class.
        /// </summary>
        ...
        /// the store.</param>
        public DistributionStoreWithoutIsLatest(string id = default(string), string name = default(string), string type = default(string), string publishingStatus = default(string))
        {
            Id = id;
            Name = name;
            Type = type;
