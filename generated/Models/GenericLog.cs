...
namespace Balivo.AppCenterClient.Models
{
    ...
    public partial class GenericLog
    {
        ...
        /// </param>
        public GenericLog(string type, System.DateTime timestamp, System.Guid installId, Device device, System.Guid? sessionId = default(System.Guid?), string eventId = default(string), string eventName = default(string), string messageId = default(string), IDictionary<string, string> properties = default(IDictionary<string, string>))
        {
            Type = type;
            Timestamp = timestamp;
            InstallId = installId;
