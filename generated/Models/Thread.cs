...
namespace Balivo.AppCenterClient.Models
{
    ...
    public partial class Thread
    {
        ...
        public Thread(string title, IList<StackFrame> frames, Exception exception = default(Exception), bool? relevant = default(bool?), string platform = default(string), bool? crashed = default(bool?))
        {
            Title = title;
            Frames = frames;
            Exception = exception;
